...
1.  **Rubric Upload**: The user provides the assignment requirements.
...
- **Input Methods**:
    - **File Upload**: Support for images or text files.
...
**1. Create Project**
Send a `POST` request to `/scribe` with the rubric content.
