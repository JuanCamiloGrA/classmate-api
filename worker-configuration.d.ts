/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0aa50e10786d9f21641029e7667ce72)
// Runtime types generated with workerd@1.20260128.0 2025-12-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ClassmateAgent";
	}
	interface Env {
		DB: D1Database;
		CLERK_NEW_USER_WEBHOOK_SECRET: SecretsStoreSecret;
		CLERK_UPDATE_USER_WEBHOOK_SECRET: SecretsStoreSecret;
		ALLOWED_ORIGIN: SecretsStoreSecret;
		CLERK_SECRET_KEY: SecretsStoreSecret;
		CLERK_PUBLISHABLE_KEY: SecretsStoreSecret;
		R2_S3_API_ENDPOINT: SecretsStoreSecret;
		R2_ACCESS_KEY_ID: SecretsStoreSecret;
		R2_SECRET_ACCESS_KEY: SecretsStoreSecret;
		R2_TEMPORAL_BUCKET_NAME: SecretsStoreSecret;
		AI_GATEWAY_API_KEY: SecretsStoreSecret;
		PROCESSING_SERVICE_URL: SecretsStoreSecret;
		INTERNAL_API_KEY: SecretsStoreSecret;
		INTERNAL_SCRIBE_API_KEY: SecretsStoreSecret;
		SCRIBE_HEAVY_API_URL: SecretsStoreSecret;
		R2_S3_PERSISTENT_API_ENDPOINT: SecretsStoreSecret;
		R2_PERSISTENT_ACCESS_KEY_ID: SecretsStoreSecret;
		R2_PERSISTENT_SECRET_ACCESS_KEY: SecretsStoreSecret;
		R2_PERSISTENT_BUCKET_NAME: SecretsStoreSecret;
		ASSETS: Fetcher;
		R2_PRESIGNED_URL_EXPIRATION_SECONDS: "300";
		ENVIRONMENT: string;
		ClassmateAgent: DurableObjectNamespace<import("./src/index").ClassmateAgent>;
		SUMMARIZE_CLASS_WORKFLOW: Workflow<Parameters<import("./src/index").SummarizeClassWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PRESIGNED_URL_EXPIRATION_SECONDS" | "ENVIRONMENT">> {}
}
